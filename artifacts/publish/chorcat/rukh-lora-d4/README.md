...
The model's own probability for `d2d4` from the opening position, read off the
...
| Puzzles solved | 37.5 % | 37.3 % |


## How it was trained

200,000 games selected with `split_part(uci, ' ', 1) = 'd2d4' AND white_elo >= 1800 AND black_elo >= 1800`, from the
