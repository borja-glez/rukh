...
- Measured in the [single results table](https://lab.rukh.borjaglez.com/proyecto/) as the stage `lora-e4`: every stage of the course, the same suite, the same day.
- Bring it to the paths the configs read: `uv run rukh pull lora-e4`.
